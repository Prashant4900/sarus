...
## Creating a Module
To create a new module, you can use the `sarus create module` command. This command will generate a new module structure with the necessary files and directories.
...
```dart title="lib/hello/middlewares.dart"
import 'package:sarus/sarus.dart';
...
```dart title="lib/config/router.dart"
